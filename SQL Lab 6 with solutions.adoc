...
SHOW VARIABLES LIKE 'local_infile';
```
image::https://user-images.githubusercontent.com/63274055/147602670-02854a8a-38dd-46fb-98fe-b470bfd69fbe.png[width=400]
=== Setting the bulk import option to ON:
```sql
SET
  GLOBAL local_infile = 1;
```
image::https://user-images.githubusercontent.com/63274055/147602872-1cf71bbd-b083-48f0-999b-1bd0e16518ca.png[]
...
```
image::https://user-images.githubusercontent.com/63274055/147602971-9e508b86-6868-4eee-945a-bbd1c952b269.png[]
...
image::https://user-images.githubusercontent.com/63274055/147603043-22295932-0979-483e-91d2-d8b28c0794e3.png[]
...
LIMIT
  5;
```
image::https://user-images.githubusercontent.com/63274055/147603159-4d6fd3ec-f18c-4896-9c2a-a2c2598ecf0f.png[]
